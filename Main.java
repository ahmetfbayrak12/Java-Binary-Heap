...
public class Main
{
	...
	/*	Creates 100 places randomly and add them into ArrayList.	*/
	private static void addPlaces(ArrayList<Point> places,int a, int b)
	{
		for(int i = 0; i<100 ; i++)
		{
	...
	/*	Adds 100 places to Binary Heap.	*/
	private static void addBinaryHeap(ArrayList<Point> places, BinaryHeapPoint bhp)
	{
		for(int i = 0 ; i < 100 ; i++)
		{
	...
	/*	Checks whether n is higher than 100 and prints places.	*/
	private static void printOutput(BinaryHeapPoint bhp, int n, Scanner scn)
	{
