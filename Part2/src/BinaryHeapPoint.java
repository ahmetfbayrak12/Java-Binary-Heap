...
public class BinaryHeapPoint 
{
	...
	private void heapifyUpPrice(int i) 		// Up function for objects which their distances are less than 200.
	{
	...
	private void heapifyUpDistance(int i)	// Up function for objects which their distances are higher than 200.
	{
		Point temp = heap.get(i);
	...
	private void heapifyDownPrice(int j)	// Down function for objects which their distances are less than 200.
	{
	...
	private void heapifyDownDistance(int j)	// Down function for object which their distances are higher than 200.
	{
		int child;
		Point temp = heap.get(j);
	...
	private int minChildPrice(int ind) 			// Find best child function for object which their distance are less than 200.
	    {
	...
	private int minChildDistance(int ind)		// Find best child function for object which their distance are higher than 200.
	{
        int bestChild = kthChild(ind, 1);
        int k = 2;
        int pos = kthChild(ind, k);
